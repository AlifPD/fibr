...
fun reduceImageFile(file: File): File {
    ...
    do{
        ...
        bitmapRotated.compress(Bitmap.CompressFormat.JPEG, compressQuality, bmpStream)
    ...
    bitmapRotated.compress(Bitmap.CompressFormat.JPEG, compressQuality, FileOutputStream(file))
